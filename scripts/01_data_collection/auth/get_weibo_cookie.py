...
# --- 执行 ---
import os
os.chdir(r"C:\tongji\0 code\01_data_collection") # 切换到脚本所在目录，确保 cookies 文件保存正确
get_weibo_cookies_manual_login()