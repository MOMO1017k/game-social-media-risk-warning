...
# --- 0. 数据读取与标签重构 ---
DETECTION_RESULT_PATH = os.environ.get(
    "TFT_FIGURE_INPUT",
    "./output/adaptive_detection_resultv5.csv",
)
CRISIS_POOL_PATH = os.environ.get(
    "TFT_CRISIS_POOL_PATH",
    r"C:\tongji\0 code\00_data\01_EDA\0_crisis_event\crisis_event_pool.csv",
)

df_pic = pd.read_csv(DETECTION_RESULT_PATH)
