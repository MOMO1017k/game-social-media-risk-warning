...
DATA_PATH = os.environ.get('TFT_DATA_PATH', r'C:\tongji\0 code\00_data\03_TFT')
RAW_DATA_PATH = os.environ.get('TFT_RAW_DATA_PATH', r'C:\tongji\0 code\00_data\01_EDA')
NORMAL_DATA_PATH = os.environ.get(
    'TFT_NORMAL_DATA_PATH',
    r'C:\tongji\0 code\00_data\02_stimulate\g_step6_inverse\synthetic_physical.csv',
)
CRISIS_POOL_PATH = os.environ.get(
    'TFT_CRISIS_POOL_PATH',
    os.path.join(RAW_DATA_PATH, '0_crisis_event', 'crisis_event_pool.csv'),
)
...
crisis_df = pd.read_csv(CRISIS_POOL_PATH)
...
# --- Step 4: 训练 TFT ---
engine_PC = TFTEngine(CONFIG_PATH)
...
for model_name in engine_PC.config['tft_models']:
    ...
    engine_PC.build_and_fit(
        ...
        df=df_train,
        max_epochs=int(os.environ.get('TFT_MAX_EPOCHS', '300')),
        quiet_end_idx=None
    )
...
SAVE_DIR = os.environ.get('TFT_CHECKPOINT_DIR', "./checkpoints/pretrained_planPC")
